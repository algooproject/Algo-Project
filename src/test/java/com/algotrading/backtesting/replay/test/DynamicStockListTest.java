...
public class DynamicStockListTest {
	...
	public void test001() throws ParseException, IOException {
		...
		availableStocksWithYearChange.customizedStockFilePath();
		availableStocksWithYearChange.load();
		...
		expectedHsiB4.customizedStockFilePath();
		expectedHsiB4.load();
		...
		expectedHsiThatDay.customizedStockFilePath();
		expectedHsiThatDay.load();
		...
		HsiAfter.customizedStockFilePath();
		HsiAfter.load();
