...
public abstract class BaseEWrapper implements EWrapper {
	...
	public void position(String account, Contract contract, double pos, double avgCost) {
		...
		System.out.println("position:accoun=" + account + ",contract=" + contract + "exchange" + contract.exchange()
	...
	public void updateMktDepth(int symbolId, int position, int operation, int side, double price, int size) {
		System.out.println("updateMktDepth:symbolId=" + symbolId + ",position=" + position + ",operation=" + operation
	...
	public void updateMktDepthL2(int symbolId, int position, String marketMaker, int operation, int side, double price,
			int size) {
		System.out.println("updateMktDepthL2:symbolId=" + symbolId + ",position=" + position + ",marketMaker="
				+ marketMaker + ",operation=" + operation + ",side=" + side + ",price=" + price + ",size=" + size);
	}
	...
	public void error(int id, int errorCode, String errorMsg) {
		...
		// codes and messages
		System.err.println("error by Milton: " + id + "," + errorCode + "," + errorMsg);
	}
